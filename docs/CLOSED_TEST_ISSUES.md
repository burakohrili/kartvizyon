...
| iOS `WatchdogTermination` — Sentry `8c33888a`, iPhone 16 Pro, iOS 26.6.1, sürüm `1.0.0+46` | **Sebep belirlenemedi.** Bu olay gözlemlenmez, çıkarsanır: çökme raporu yoktur, SDK "uygulama temiz kapanmadı" durumundan tahmin eder ve yanlış pozitif üretebilir. Tek olay, tek cihaz, ve sürüm 46 güncelin (50) iki gerisinde. Saha modu uygulamayı iOS'ta saatlerce arka planda canlı tutabilen tek yerimiz olduğu için ilk şüpheli o; ölçebilmek adına saha modu durumu artık Sentry olaylarına iliştiriliyor (`field_mode.active`). Bir sonraki olayda modun açık olup olmadığı görülecek. |
